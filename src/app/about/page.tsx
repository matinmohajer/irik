    ...
    <>
      ...
      <div className="container mag-hero">
        ...
        <p className="tab-prose" style={{ marginTop: 14 }}>
          آیریک از دل بازار بزرگ کامپیوتر اصفهان شروع شد؛ جایی که هر روز با نیاز واقعی مشتری‌ها روبه‌رو می‌شویم. تمرکز ما روی
          لپ‌تاپ، کامپیوتر، کنسول بازی و لوازم جانبی است — با انتخاب دقیق کالا، قیمت شفاف و مشاوره‌ای که واقعاً به کارتان می‌آید.
        </p>
      </div>
